...
const setDOMElements = (timeLeftElementStamp) => { 
...
document.addEventListener('DOMContentLoaded', function() {
	...
	const endpoint = `http://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&appid=313cada7e47e960a75817bfb3dfef753&units=metric&lang=nl&cnt=1`
